...
from backend.data.alpaca import AlpacaDataProvider  # noqa: E402
...
def main():
    ...
    print(
        f"✅ Mode: {'Paper Trading' if paper.lower() == 'true' else 'Live Trading'}\n"
    )
    ...
    try:
        ...
        if price > 0:
            ...
            print(
                "⚠️  Could not fetch latest price (might be normal if market is closed)\n"
            )
